 ...
 * generated by Xtext
 */
package be.unamur.xtext.ui.contentassist.antlr;
...
public class CoreAlParser extends AbstractContentAssistParser {
	...
	@Override
	protected be.unamur.xtext.ui.contentassist.antlr.internal.InternalCoreAlParser createParser() {
		be.unamur.xtext.ui.contentassist.antlr.internal.InternalCoreAlParser result = new be.unamur.xtext.ui.contentassist.antlr.internal.InternalCoreAlParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStructuralPropertyAccess().getAlternatives(), "rule__StructuralProperty__Alternatives");
					...
					put(grammarAccess.getReferenceableTypeAccess().getAlternatives(), "rule__ReferenceableType__Alternatives");
					put(grammarAccess.getMultiplicityUpperBoundAccess().getAlternatives(), "rule__MultiplicityUpperBound__Alternatives");
					...
					put(grammarAccess.getMetamodelAccess().getGroup_0(), "rule__Metamodel__Group_0__0");
					...
					put(grammarAccess.getOperationAccess().getGroup_8_0(), "rule__Operation__Group_8_0__0");
					put(grammarAccess.getParameterAccess().getGroup(), "rule__Parameter__Group__0");
					put(grammarAccess.getReturnTypeAccess().getGroup_0(), "rule__ReturnType__Group_0__0");
					put(grammarAccess.getReferenceableTypeReferenceAccess().getGroup(), "rule__ReferenceableTypeReference__Group__0");
					...
					put(grammarAccess.getMetamodelAccess().getNameAssignment_0_1(), "rule__Metamodel__NameAssignment_0_1");
					put(grammarAccess.getMetamodelAccess().getImportsAssignment_1(), "rule__Metamodel__ImportsAssignment_1");
					put(grammarAccess.getMetamodelAccess().getTypesAssignment_2(), "rule__Metamodel__TypesAssignment_2");
					...
					put(grammarAccess.getClassAccess().getFeaturesAssignment_5(), "rule__Class__FeaturesAssignment_5");
					...
					put(grammarAccess.getOperationAccess().getStatementsAssignment_8_0_1(), "rule__Operation__StatementsAssignment_8_0_1");
					put(grammarAccess.getOperationAccess().getIsAbstractAssignment_8_1(), "rule__Operation__IsAbstractAssignment_8_1");
					put(grammarAccess.getParameterAccess().getNameAssignment_0(), "rule__Parameter__NameAssignment_0");
					put(grammarAccess.getParameterAccess().getTypeAssignment_2(), "rule__Parameter__TypeAssignment_2");
					put(grammarAccess.getReferenceableTypeReferenceAccess().getCollectionAssignment_0(), "rule__ReferenceableTypeReference__CollectionAssignment_0");
					put(grammarAccess.getReferenceableTypeReferenceAccess().getTypeAssignment_1(), "rule__ReferenceableTypeReference__TypeAssignment_1");
					put(grammarAccess.getReferenceableTypeReferenceAccess().getMultiplicityAssignment_2(), "rule__ReferenceableTypeReference__MultiplicityAssignment_2");
					put(grammarAccess.getPrimitiveTypeReferenceAccess().getCollectionAssignment_0(), "rule__PrimitiveTypeReference__CollectionAssignment_0");
					put(grammarAccess.getPrimitiveTypeReferenceAccess().getTypeAssignment_1(), "rule__PrimitiveTypeReference__TypeAssignment_1");
					put(grammarAccess.getPrimitiveTypeReferenceAccess().getMultiplicityAssignment_2(), "rule__PrimitiveTypeReference__MultiplicityAssignment_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			be.unamur.xtext.ui.contentassist.antlr.internal.InternalCoreAlParser typedParser = (be.unamur.xtext.ui.contentassist.antlr.internal.InternalCoreAlParser) parser;
