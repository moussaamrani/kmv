...
public class CoreAlSyntacticSequencer extends AbstractSyntacticSequencer {

	protected CoreAlGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (CoreAlGrammarAccess) access;
	...
	protected String getUnassignedRuleCallToken(EObject semanticObject, RuleCall ruleCall, INode node) {
		...
		else if(ruleCall.getRule() == grammarAccess.getCollectionRule())
			return getCollectionToken(semanticObject, ruleCall, node);
	 ...
	 * ;
	 */
	protected String getCollectionToken(EObject semanticObject, RuleCall ruleCall, INode node) {
		if (node != null)
			return getTokenText(node);
		return "";
	}
